...
/** Keep the email disclaimer accessible from signatures but out of search results. */
function daktravel_robots_for_utility_pages( $robots ) {
...
add_filter( 'wp_robots', 'daktravel_robots_for_utility_pages' );
