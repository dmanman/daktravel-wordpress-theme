...
<div class="utility-bar">
    <div class="container utility-inner">
        <div class="utility-proof"><strong>מאז 2006</strong><span>יוהנסבורג</span><span>סוכן IATA מוסמך</span><span>חבר ASATA</span></div>
        <div class="utility-links">
            <a class="utility-specialist" href="<?php echo esc_url( daktravel_native_hebrew_url( 'flights' ) ); ?>">ישראל ← דרום אפריקה</a>
            <a href="<?php echo esc_url( daktravel_native_hebrew_url( 'contact' ) ); ?>">הזמנה קיימת</a>
            <span class="utility-language-slot"><?php echo wp_kses_post( daktravel_native_language_switcher() ); ?></span>
        </div>
    </div>
</div>
...
<header class="site-header">
    <div class="container header-inner">
        <div class="site-branding">
            <a class="legacy-logo-link dak-logo-link" href="<?php echo esc_url( daktravel_native_hebrew_url( 'home' ) ); ?>" aria-label="D.A.K Travel בעברית">
        ...
        <nav class="site-nav" aria-label="ניווט ראשי">
            <ul>
                ...
                <li><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'contact' ) ); ?>">צור קשר</a></li>
            </ul>
        </nav>

        <div class="header-cta">
            <a class="btn btn--whatsapp btn--compact" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url( daktravel_whatsapp_url( 'שלום D.A.K Travel. אשמח לעזרה עם נסיעה מישראל לדרום אפריקה.' ) ); ?>">WhatsApp</a>
        </div>
        ...
        <details class="mobile-menu">
            ...
            <div class="mobile-menu-panel">
                ...
                <a href="<?php echo esc_url( daktravel_native_hebrew_url( 'about' ) ); ?>">אודות D.A.K</a>
                <a href="<?php echo esc_url( daktravel_native_hebrew_url( 'contact' ) ); ?>">צור קשר</a>
                <div class="mobile-menu-divider"></div>
                <a class="mobile-menu-whatsapp" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url( daktravel_whatsapp_url( 'שלום D.A.K Travel. אשמח לעזרה עם נסיעה מישראל לדרום אפריקה.' ) ); ?>">WhatsApp</a>
            </div>
        </details>
    </div>
</header>
