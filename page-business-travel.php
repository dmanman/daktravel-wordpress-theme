...
<section class="dak-page-hero">
    <div class="container dak-page-hero-grid">
        <div class="dak-page-hero-copy">
            ...
            <div class="dak-page-actions"><a class="btn btn--whatsapp" href="<?php echo esc_url( daktravel_whatsapp_url( 'Good day D.A.K Travel. I would like to discuss business or organisational travel.' ) ); ?>">WhatsApp Us</a><a class="btn btn--outline" href="<?php echo esc_url( home_url('/contact/#enquiry') ); ?>">Email / Enquire</a></div>
        </div>
        <?php echo wp_kses_post( daktravel_media_slot( 'daktravel_business_image', 'Business travel', 'Business travel' ) ); ?>
    </div>
</section>
...
<section class="dak-quiet-cta"><div class="container dak-quiet-cta-inner"><div><div class="eyebrow">Business enquiry</div><h2>Tell us how your team travels.</h2><p>We will suggest a straightforward way for D.A.K to manage it.</p></div><div class="dak-page-actions"><a class="btn btn--whatsapp" href="<?php echo esc_url( daktravel_whatsapp_url( 'Good day D.A.K Travel. I would like to discuss a business travel account.' ) ); ?>">WhatsApp Us</a><a class="btn btn--outline" href="<?php echo esc_url( home_url('/contact/#enquiry') ); ?>">Send Enquiry</a></div></div></section>
</main>
<?php get_footer(); ?>
