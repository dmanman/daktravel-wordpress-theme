<footer class="site-footer">
    <div class="container footer-grid">
        <div>
            ...
            <p><a href="<?php echo esc_url( daktravel_whatsapp_url( 'Good day D.A.K Travel. I would like assistance with a travel enquiry.' ) ); ?>">WhatsApp: +27 82 440 6144</a><br>
            <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">Email / Send an enquiry</a><br>
    ...
    <div class="container" style="margin-top:32px;border-top:1px solid rgba(255,255,255,.15);padding-top:20px;font-size:.9rem;">
        ...
        <p>We treat passenger and booking information with discretion and ask only for information needed to arrange and service your travel. Please see our Privacy &amp; Confidentiality notice.</p>
...
<div class="mobile-actions">
    ...
    <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">Email</a>
