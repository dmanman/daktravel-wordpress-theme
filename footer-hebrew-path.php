...
<footer class="site-footer">
    <div class="container footer-grid">
        ...
        <div><h3 style="color:#fff;">שירותים</h3><p><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'flights' ) ); ?>">טיסות מישראל לדרום אפריקה</a><br><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'groups' ) ); ?>">קבוצות ומשלחות</a><br><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'business' ) ); ?>">נסיעות עסקים</a><br><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'about' ) ); ?>">אודות</a><br><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'contact' ) ); ?>">צור קשר</a></p></div>
...
<div class="mobile-actions"><a target="_blank" rel="noopener noreferrer" href="<?php echo esc_url( daktravel_whatsapp_url( 'שלום D.A.K Travel. אשמח לעזרה עם נסיעה מישראל לדרום אפריקה.' ) ); ?>">WhatsApp</a><a href="<?php echo esc_url( daktravel_native_hebrew_url( 'contact' ) ); ?>">צור קשר</a><a href="<?php echo esc_url( daktravel_native_english_url_for_hebrew_key( $dak_he_key ) ); ?>">English</a></div>
<?php wp_footer(); ?>
</body>
</html>
